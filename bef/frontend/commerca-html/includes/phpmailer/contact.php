...
function init_mail()
{
	...
	$port = 465;						// Set the SMTP port number - likely to be 25, 465 or 587
	$username = 'ninethemedemo@gmail.com';	// Username to use for SMTP authentication
	$password = 'theme!@3333';			// Password to use for SMTP authentication
...
$configs['to'] = 'ninethemedemo@gmail.com';			// who should recieve the contact form data
$configs['to_name'] = 'Ninetheme';			// who should recieve the contact form data
$configs['from'] = 'ninethemedemo@gmail.com';		// Set who the thanks message is to be sent from
$configs['from_name'] = 'Commerca';
